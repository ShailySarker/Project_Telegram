...
const ChatWindow = ({ chatId, chartSelection }) => {
  ...
  return (
    <div className='chat-window dark:text-white text-black dark:bg-gray-800 bg-white lg:h-screen h-screen flex flex-col' style={{ backgroundImage: `url(${!isDarkMode ? darkBG : lightBG})` }}>
      <div className="lg:h-[88%] h-[89%] overflow-y-scroll ">
        {/* <img src={isDarkMode ? darkBG : lightBG} alt="Theme based background" /> */}
        <div>
          {/* header info */}
          <div className='flex justify-between items-center lg:px-7 md:px-7 px-4 lg:py-4 md:py-3 py-[10px] dark:bg-gray-800 bg-white dark:text-white text-black sticky lg:top-0 top-0 w-full z-20'>
          ...
          {/* messages */}
          <div className='lg:px-8 md:px-6 px-4 lg:pt-2'>
            {/* <div className='lg:px-8 md:px-6 px-4 lg:pt-2 lg:h-[560px] md:h-[835px] h-[480px] overflow-y-scroll'> */}
            <div>
              {Object.keys(groupedMessages)?.map(date => (
                <div key={date}>
                  <div className="sticky lg:top-24 md:top-16 top-14 z-10 text-center md:text-sm text-xs font-bold text-white py-2 flex">
      ...
      <div className='absolute bottom-0 z-20 lg:w-[65%] md:w-[80%] lg:mx-0 md:mx-20 lg:h-[12%] h-[10%] lg:py-5 md:py-6 py-2 '>
        <div className='flex items-center justify-center mx-auto ' >
          <HiOutlineEmojiHappy className='relative lg:left-12 left-9 -ml-0 lg:text-3xl text-2xl' />
          <input placeholder='Message' className='shadow-lg lg:py-3 py-[10px] lg:px-14 px-12 lg:w-1/2 md:w-full w-[74%] rounded-[90px] dark:bg-gray-800 bg-white dark:text-white text-black placeholder:font-medium lg:placeholder:text-lg lg:text-lg' type="text" />
