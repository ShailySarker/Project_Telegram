...
const NavBar = () => {
    ...
    return (
        <nav className="bg-gray-100 dark:bg-gray-950 text-black dark:text-white lg:py-4 md:py-[14px] py-[10px]  lg:px-8 md:px-8 px-4 lg:grid grid-cols-3 flex justify-between items-center ">
